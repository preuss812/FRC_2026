...
public class RaiseIntakeSlowlyCommand extends Command {
  private final IntakeDeploymentSubsystem m_intakeDeploymentSubsystem;

  /** Creates a new RaiseIntakeSlowlyCommand. */
  public RaiseIntakeSlowlyCommand(IntakeDeploymentSubsystem intakeDeploymentSubsystem) {
  ...
  public void initialize() {
    m_intakeDeploymentSubsystem.setRPM(Constants.IntakeDeploymentConstants.kIntakeDeploymentUpSlowlyRPM);
  }
